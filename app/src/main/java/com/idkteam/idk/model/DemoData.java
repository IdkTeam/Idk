...
/**
 * Created by Danny on 13/08/2016.
 */
public class DemoData {
    ...
    private static final int icon = R.drawable.ic_action_add;

    public static List<PostItem> getListData() {
        List<PostItem> data = new ArrayList<>();
